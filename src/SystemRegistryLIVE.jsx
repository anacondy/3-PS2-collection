  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
      {particles.map(p => (
        <div
          key={p.id}
          className="absolute w-1 h-1 bg-red-500 rounded-full opacity-0"
          style={{
            left: p.left,
            top: p.top,
            '--tx': p.tx,
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-md flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-neutral-950 border border-red-900/50 shadow-[0_0_60px_rgba(153,27,27,0.15)] rounded-sm overflow-hidden relative font-mono animate-in fade-in zoom-in duration-300">
        ...
        {/* Background "Alive" Effects */}
        <FloatingParticles />
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-5 mix-blend-overlay pointer-events-none"></div>
        
        {/* Glowing Border Pulse */}
        <div className="absolute inset-0 border border-red-500/20 animate-pulse pointer-events-none"></div>

        {/* Header */}
        <div className="bg-red-950/20 border-b border-red-900/30 p-4 flex justify-between items-center relative z-10">
            <div className="flex items-center gap-3">
                <Terminal className="text-red-500" size={18} />
                <h2 className="text-red-500 font-bold tracking-widest text-lg flex items-center gap-1">
                  SYSTEM_REGISTRY.SYS
                  <span className="w-2 h-4 bg-red-500 animate-blink inline-block ml-1"></span>
                </h2>
            </div>
        ...
        <div className="p-8 text-neutral-300 space-y-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                    <div className="flex items-start gap-3 group">
                        <User className="text-red-600 mt-1 group-hover:text-red-400 transition-colors" size={16} />
                        <div>
                            <span className="block text-xs text-neutral-500 uppercase">Author</span>
                            <span className="text-lg font-bold text-white text-shadow-sm">Anacondy</span>
                        </div>
                    </div>
                    <div className="flex items-start gap-3 group">
                        <Calendar className="text-red-600 mt-1 group-hover:text-red-400 transition-colors" size={16} />
                        <div>
                            <span className="block text-xs text-neutral-500 uppercase">Origin Date</span>
                            <span className="text-lg font-bold text-white">November 24, 2025</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-3 group">
                        <Cpu className="text-red-600 mt-1 group-hover:text-red-400 transition-colors" size={16} />
                        <div>
                            <span className="block text-xs text-neutral-500 uppercase">Version</span>
                            <span className="text-lg font-bold text-white">v3.1.4 (STABLE)</span>
                        </div>
                    </div>
                    <div className="flex items-start gap-3 group">
                        <Lock className="text-red-600 mt-1 group-hover:text-red-400 transition-colors" size={16} />
                        <div>
                            <span className="block text-xs text-neutral-500 uppercase">Security Level</span>
                            <span className="text-lg font-bold text-green-500 drop-shadow-[0_0_5px_rgba(34,197,94,0.5)]">ROOT ACCESS</span>
                        </div>
                    </div>
                </div>
            </div>

            {/* Features List - SCROLLBAR HIDDEN */}
            <div className="border-t border-red-900/30 pt-6">
                ...
                <ul className="space-y-2 text-xs md:text-sm font-light text-neutral-400 h-48 overflow-y-auto scrollbar-hide">
                    ...
                    <li className="flex gap-2"><span className="text-red-500">[+]</span> Live Particle System (Registry)</li>
        ...
        {/* Footer */}
        <div className="bg-black/50 p-2 border-t border-red-900/30 flex justify-between px-4 text-[10px] text-red-900 font-bold uppercase tracking-widest relative z-10">
            <span className="animate-pulse">CONFIDENTIAL</span>
...
export default function App() {
  ...
  const getVisuals = () => {
    ...
    return {
        ...
        scratchOp: (highFreq > 140 && Math.random() > 0.7) ? 0.6 : 0 
    };
  };
